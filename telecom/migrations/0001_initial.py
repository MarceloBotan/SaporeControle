    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tracking_code', models.CharField(default='-', max_length=13, verbose_name='Código de Rastreio')),
                ('line_id', models.BigIntegerField(default=0)),
                ('obj_model', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='telecom.vivoboxmodel', verbose_name='Modelo')),
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='telecom.vivoboxstatus', verbose_name='Status')),
            ],
        ),
        migrations.CreateModel(
            name='Smartphone',
            fields=[
                ...
                ('tracking_code', models.CharField(default='-', max_length=13, verbose_name='Código de Rastreio')),
                ('line_id', models.BigIntegerField(default=0)),
                ('obj_model', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='telecom.smartphonemodel', verbose_name='Modelo')),
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='telecom.smartphonestatus', verbose_name='Status')),
            ],
        ),
        migrations.CreateModel(
            name='Line',
